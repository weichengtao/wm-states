...
STAGE_INFO = {
    ...
    'states': ('Identify states', 'Label on/off periods using confidence thresholds and cluster rules.'),
    'activity': ('Compare activity', 'Inspect population activity and state-dependent structure.'),
    'prepare': ('Prepare features', 'Build trial outcomes, predictors, and within-session holdout inputs.'),
    'models': ('Model families', 'Compare off-duration associations and conditional within-session predictions.'),
